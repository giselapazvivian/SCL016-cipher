...
## 1. 
Cifrado que ayudará a mujeres que se encuentren en riesgo de violencia o que no se sienten seguras en algún lugar, puedan enviar un mensaje a alguna persona de confianza.

El cifrado césar utiliza la sustitución para cifrar un texto original, utilizando las frases y transformandolas en otras letras del mismo abecedario. Este cifrado utiliza el desplazamiento que uno desee y según el número que uno indique
